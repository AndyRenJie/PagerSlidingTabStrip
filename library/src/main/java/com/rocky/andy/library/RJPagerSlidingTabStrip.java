...
public class RJPagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public RJPagerSlidingTabStrip(Context context) {
        this(context, null);
    }

    public RJPagerSlidingTabStrip(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RJPagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        // get system 布局XML attrs (android:padding and android:paddingLeft and paddingRight..)
        ...
        int paddingLeft = padding > 0 ? padding : a.getDimensionPixelSize(PADDING_LEFT_INDEX, 0);
        int paddingRight = padding > 0 ? padding : a.getDimensionPixelSize(PADDING_RIGHT_INDEX, 0);
        a.recycle();
        ...
        tabTextColor = a.hasValue(R.styleable.PagerSlidingTabStrip_pstsTextColor) ? a.getColorStateList(R.styleable.PagerSlidingTabStrip_pstsTextColor) : null;
        tabImageIndex = a.getInteger(R.styleable.PagerSlidingTabStrip_pstsImageIndex,tabImageIndex);
    ...
    private class PageListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            //Unselect prev item
            if (position > 0) {
                View prevTab = tabsContainer.getChildAt(position - 1);
                unSelect(prevTab);
            }
            //Unselect next item
